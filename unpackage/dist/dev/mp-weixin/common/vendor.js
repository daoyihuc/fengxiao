...
function MyCode(data) {
  return (0, _request.default)('MyCode', data);
}

/* 关于我们接口 */
function AboutUs(data) {
  return (0, _request.default)('AboutUs', data);
}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.StoreEntry = StoreEntry;exports.StoreStatus = StoreStatus;exports.Store = Store;exports.StoreDetail = StoreDetail;exports.StoreList = StoreList;exports.StoreShare = StoreShare;exports.CountyGgent = CountyGgent;exports.CountyGgentDetail = CountyGgentDetail;exports.PromotionActivity = PromotionActivity;exports.CountyGgentProfit = CountyGgentProfit;exports.AddStoreOrder = AddStoreOrder;exports.GetStoreMember = GetStoreMember;var _request = _interopRequireDefault(__webpack_require__(/*! ../../utils/request.js */ 9));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

/* 门店入驻接口 */
function StoreEntry(data) {
  return (0, _request.default)('StoreEntry', data);
}

/* 门店审核状态接口 */
function StoreStatus(data) {
  return (0, _request.default)('StoreStatus', data);
}

/* 门店接口 */
function Store(data) {
  return (0, _request.default)('Store', data);
}

/* 门店详情接口 */
function StoreDetail(data) {
  return (0, _request.default)('StoreDetail', data);
}

/* 全部门店接口 */
function StoreList(data) {
  return (0, _request.default)('StoreList', data);
}
...
/* 订单提交 */
function AddStoreOrder(data) {
  return (0, _request.default)('AddStoreOrder', data);
}
/* 用户列表 */
function GetStoreMember(data) {
  return (0, _request.default)('GetStoreMember', data);
}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _message = _interopRequireDefault(__webpack_require__(/*! ./message.js */ 312));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 4:
/*!**************************************************************!*\
  !*** D:/ws/work/分销-2020-10-26/Store_distribution/pages.json ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 8:
/*!**********************************************************************!*\
  !*** D:/ws/work/分销-2020-10-26/Store_distribution/api/Index/index.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 登录 */
function Logn(data) {
  return (0, _request.default)('Login', data);
}
/* 
   首页
   */
function getIndexData(data) {
  return (0, _request.default)('CardBag', data);
}

/* 卡包返现记录列表 */
function RecurrenceRecord(data) {
  return (0, _request.default)('RecurrenceRecord', data);
}
/* 提现接口 */
function Withdrawal(data) {
  return (0, _request.default)('Withdrawal', data);
}
/* 卡包提现记录接口 */
...
/* 个人信息接口 */
function getinfot(data) {
  return (0, _request.default)('Mine', data);
}
/* 编辑个人信息接口 */
function EditMine(data) {
  return (0, _request.default)('EditMine', data);
}
...
/***/ 9:
/*!********************************************************************!*\
  !*** D:/ws/work/分销-2020-10-26/Store_distribution/utils/request.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = request;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 10));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         */
var baseUrl = 'https://door.sh997.com/';function
request(_x, _x2, _x3, _x4) {return _request.apply(this, arguments);}
...
function _request() {_request = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(mehtod, params, type, callBack) {var http, promise;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0: //创建一个名为request请求的方法函数
            if (!type) {type = 'POST';} // let header = {
            //   //设置请求头信息
            ...
            // };
            http = { url: baseUrl + mehtod, data: params, method: type };promise = new Promise(function (resolve, reject) {uni.request(http).then(function (res) {var newdata = res[1].data; // if (newdata.code == 403) {
                if (newdata == -1) {//如果错误码为 -1 提示
                  uni.showToast({ title: res[1].data.msg, icon: 'none' });}resolve(res[1].data);}).catch(function (err) {reject(err);console.log(err);});});return _context.abrupt("return", promise);case 4:case "end":return _context.stop();}}}, _callee);}));return _request.apply(this, arguments);}
